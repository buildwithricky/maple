...
const BottomSheetModal: React.FC<BottomSheetModalProps> = ({ isVisible, onClose, onVerifyAccount }) => {
  const translateY = React.useRef(new Animated.Value(300)).current; // Initial position off screen

  useEffect(() => {
    if (isVisible) {
      translateY.setValue(300); // Reset position off screen
            ...
            <Animated.View style={styles.modalOverlay}>
              <PanGestureHandler onGestureEvent={handleGesture} onHandlerStateChange={handleGestureStateChange}>
                <Animated.View style={[styles.modalContainer, { transform: [{ translateY }] }]}>
                  ...
                  <Image source={require("../../../../assets/MappleApp/dummy.png")} style={styles.modalImage} />
