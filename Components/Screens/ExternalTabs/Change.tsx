...
const Change = () => {
  const navigation = useNavigation<ScreenNavigationProp<'Change3' | 'Change2'>>();
      ...
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.loadingContainer}>
          <View style={styles.contentContainer}>
            <Text style={styles.title_two}>Input your Pin</Text>
            <Text style={styles.subtitle}>Input your current pin</Text>
          </View>
